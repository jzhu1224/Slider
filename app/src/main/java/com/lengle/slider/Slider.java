...
public class Slider extends CustomView {
                ...
                if ((event.getX() <= getWidth() && event.getX() >= 0)) {
                    ...
                    if (numberIndicator != null) {
                        ...
                        numberIndicator.indicator.finalY = Utils
                                .getRelativeTop(this) - getHeight() / 4;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if (!press) {
            ...
            paint.setAntiAlias(true);
            String textVale;
            textVale = String.valueOf(value);
            canvas.drawText(textVale, (ViewHelper.getX(ball) + ball.getWidth() / 2) - getTextSizeForWidth(paint, textVale) / 2,
                    getHeight() / 2 - Utils.dpToPx(14, getResources()), paint);
    ...
    private static float getTextSizeForWidth(Paint paint
            ,String text) {
    ...
    protected void setAttributes(AttributeSet attrs) {
        ...
        // Set size of view
        setMinimumHeight(Utils.dpToPx(49, getResources()));
        ...
        LayoutParams params = new LayoutParams(Utils.dpToPx(12,
                getResources()), Utils.dpToPx(12, getResources()));
    ...
    class Indicator extends RelativeLayout {
        ...
        protected void onDraw(Canvas canvas) {
            ...
            if (animate) {
                ...
                y -= Utils.dpToPx(2, getResources());
                size += Utils.dpToPx(2, getResources());
            }

            mMarkPath = getMarkPath(mMarkPath,ViewHelper.getX(ball)
                            + Utils.getRelativeLeft((View) ball.getParent())
                            + ball.getWidth() / 2, y,size,mFactor);

            canvas.drawPath(mMarkPath,paint);
                ...
                ViewHelper
                        .setX(numberIndicator.numberIndicator,
                                (ViewHelper.getX(ball)
                                        ...
                                        - size);
                ViewHelper.setY(numberIndicator.numberIndicator, y - size*2*mFactor);
    ...
    class NumberIndicator extends Dialog {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            numberIndicator.setTextSize(TypedValue.COMPLEX_UNIT_SP,12.5f);
